...
def get_params():
    params = {
        'weight': 'kxl/yolov5-master/runs/train/YOLOv5s-EMBSFPN-Mdown-FDRFD-MSRFD-CEF2-dwconv2d+relubn/weights/best.pt',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/mnt/workspace/kxl/priture-heatmap/BrokenEnd-M-ZY-102E-230731-0-40.png', 'result')