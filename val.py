...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default= "/root/kxl/yolov5-master/runs/train/YOLOv5s-EMBSFPN-Mdown-FDRFD-MSRFD-CEF2-dwconv2d+gelubn/weights/best.pt", help="model path(s)")#改
