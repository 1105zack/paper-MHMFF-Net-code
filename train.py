...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="/root/kxl/yolov5-master/models/yolov5s-EMBSFPN-Mdown-FDRFD-MSRFD-CEF2-dwconv2d+gelubn.yaml", help="model.yaml path") #改
    parser.add_argument("--data", type=str, default="/root/autodl-tmp/ZY-2/fabric.yaml", help="dataset.yaml path")##改
    parser.add_argument("--hyp", type=str, default=ROOT / "data/hyps/hyp.scratch-low.yaml", help="hyperparameters path")
    parser.add_argument("--epochs", type=int, default=300, help="total training epochs")
    parser.add_argument("--batch-size", type=int, default=32, help="total batch size for all GPUs, -1 for autobatch")
    parser.add_argument("--imgsz", "--img", "--img-size", type=int, default=640, help="train, val image size (pixels)")
    parser.add_argument("--rect", action="store_true", help="rectangular training")
    parser.add_argument("--resume", nargs="?", const=True, default=False, help="resume most recent training")#gai
